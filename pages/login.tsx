      ...
      <section className="form-page">
        <div className="container">
          <div className="back-button-section">
            <Link href="/products">
              <Link href="javascript:"><i className="icon-left"></i> Back to store</Link>
            </Link>
          </div>
          ...
          <div className="form-block">
            ...
            <form className="form" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form__btns">
                ...
                <button type="button" className="btn-social google-btn" onClick={() => signIn('google')}><img src="/images/icons/gmail.svg" alt="gmail" /> Gmail</button>
              </div>
